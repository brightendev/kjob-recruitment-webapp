$(function(){
   ...
   /*     $('#detail_1_l1 #cancel').on('click', function () {
    ...
    .on('click', "[id*=detail_] > [name*=line] > button", function(e) {
        ...
        var lineId = $(this).parent().attr("name");
        console.log('click at ' + detailId + lineId);

        var textBeforeEdit = $("#"+detailId+" [name$='"+lineId+"'] [name$='text']").text();
        ...
        $("#"+detailId+" > [name$='"+lineId+"']").html(html);

        $("#"+detailId+" [name$='"+lineId+"'] textarea").val(textBeforeEdit);
        $("#"+detailId+" [name$='"+lineId+"'] textarea").focus();

        // ======= cancel button will revert all text  =======
        $("#"+detailId+" [name$='"+lineId+"'] [name$='cancel']").on('click', function () {
        ...
        $("#"+detailId+" [name$='"+lineId+"'] [name$='save']").on('click', function () {
            console.log('save')
            var textAfterEdit = $("#"+detailId+" [name$='"+lineId+"'] textarea").val();
